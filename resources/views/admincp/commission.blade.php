...
<div class="alert alert-success">
            ...
            <form action="{{url('/savecommission')}}" method="post" class="form-horizontal" enctype="multipart/form-data">
             {{ csrf_field() }} 
              <div class="control-group">
                <label class="control-label">commission</label>
                <div class="controls">
                 <div class="input-append">
                  <input type="text" class="span11"  name="commission"  value="{{Auth::user()->commission}}"/><span class="add-on">%</span></div>
                </div>
              </div>
