...
<!-- Mirrored from friday-theme.firebaseapp.com/coupons_list.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 26 Apr 2017 09:36:40 GMT -->
                        ...
                        <div class="col-sm-12 col-md-8">
                            <ul class="nav-top nav-top-right list-inline t-xs-center t-md-right">
                                <li>
                                    ...
                                    <ul>
                                        <li><a href="coupons_list.html"><i class="fa fa-flag-en"></i>English</a>
                                        </li>
                                        <li><a href="ar/coupons_list.html"><i class="fa fa-flag-ar"></i>العربية</a>
                                        </li>
                                    </ul>
                                </li>
                                <li>
                ...
                <div class="container">
                    <nav class="nav-bar">
                        ...
                        <div id="header-navbar" class="nav-collapse">
                            <ul class="nav-menu">
                                ...
                                <li>
                                    <a href="#">Pages</a>
                                    <ul>
                                        <li><a href="index-2.html">Home Default</a>
                                        </li>
                        ...
                        <div class="nav-menu nav-menu-fixed">
                            <a href="ar/coupons_list.html" target="_blank">RTL VERSION<i class="fa fa-long-arrow-right ml-10"></i></a>
                        </div>
                    </nav>
                </div>
            </div>
                        ...
                        <div class="row row-tb-20">
                            <div class="footer-col col-sm-6">
                                <div class="footer-about">
                                    <img class="mb-40" src="assets/images/logo_light.png" alt="">
