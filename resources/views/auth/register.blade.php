                ...
                <section class="sign-area panel p-40">
                    ...
                    <div class="row row-rl-0">
                        <div class="col-sm-6 col-md-7 col-left">
                            <form class="p-40"  method="post" action="{{ url('/register') }}">
                                {{ csrf_field() }}
                                ...
                                <div class="custom-radio mb-20 col-sm-5 ">
                                    <input type="radio" name="role" id="buyer" checked value="1" required="">
                                    <label class="color-mid" for="buyer">Buyer</label>
                                </div>
                                <div class="custom-radio mb-20 col-sm-5">
                                    <input type="radio" name="role" id="seller" value="2">
                                    <label class="color-mid" for="Seller">Seller</label>
                                </div>
                                <br>
