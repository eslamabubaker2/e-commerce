        	        ...
        	        <div class="card">
        	            ...
        	            <div class="card-body collapse in">
        	                <div class="card-block">
        	                    ...
        	                    <form class="form form-horizontal" method="post" action="{{ url('/addproduct') }}" enctype="multipart/form-data" />
                                        {{ csrf_field() }}
                                        <div class="form-body">
        	                    		<h4 class="form-section"><i class="icon-head"></i> Product Info</h4>
        			                    <div class="form-group row">
                                         ...
                                         <div class="form-group row">
                                            <label class="col-md-3 label-control" for="projectinput1"> product number </label>
                                            <div class="col-md-9">
                                                <input type="text" id="projectinput1" class="form-control" placeholder="First Name" name="pnumber" />
                                            </div>
                                        </div>
        		                       <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                                <label class="col-md-3 label-control" for="projectinput1"> Contity </label>
                                                <div class="col-md-9">
                                                    <input type="text" id="projectinput1" class="form-control" placeholder="Contity" name="contity" />
                                                </div>
                                            </div>
