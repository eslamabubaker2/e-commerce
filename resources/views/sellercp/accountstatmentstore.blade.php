...
<div class="container">
 ...
 <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
             ...
             <th>Date process</th>
              ...
              <th>Buyer email</th>
               <th>Process</th>
                ...
                <th>store name</th>
                 <th>Price</th>
                 <th>Commission Website</th>
                 <th> current Balance website</th>
                 <th> current Balance store</th>
       ...
       <td style="text-align: center;">{{$invoice->email}}</td>
       <td style="text-align: center;">Was purchased</td>
       

       <td style="text-align: center;">{{$invoice->store_name}}</td>
       <td style="text-align: center;">{{$invoice->amount}}</td>
       <td style="text-align: center;">{{$invoice->commissionweb}}</td>

     <?php
       $balanceadmin=$invoice->amount*(1-$invoice->commissionweb/100.0);?> 
       <td style="text-align: center;">{{$balanceadmin}}</td>

 <?php
       $balancestore=$invoice->amount-$balanceadmin;?> 
       <td style="text-align: center;">{{$balancestore}}</td>
